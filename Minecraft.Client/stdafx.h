...
#define HRESULT_SUCCEEDED(hr) (((long)(hr)) >= 0)
#else
#define AUTO_VAR(_var, _val) auto _var = _val
#include <unordered_map>
#include <unordered_set>
...
#elif defined _SDL3
#include "SDL3/4JLibs/inc/4J_Input.h"
#include "SDL3/4JLibs/inc/4J_Profile.h"
#include "SDL3/4JLibs/inc/4J_Render.h"
#include "SDL3/4JLibs/inc/4J_Storage.h"
#else
...
#elif defined _SDL3
#include "SDL3/SDL3_App.h"
#include "SDL3/SDL3_UIController.h"
#include "SDL3/Sentient/DynamicConfigurations.h"
#include "SDL3Media/strings.h"
#else
#include "Common/Audio/SoundEngine.h"
