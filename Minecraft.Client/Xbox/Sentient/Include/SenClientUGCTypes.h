...
struct SenUGCMetaData
{
    ...
    {
#pragma warning( \
    disable : 4996) // @TODO - Removed once Int16 Descriptors are deprecated
...
#pragma warning(default : 4996)
    ...
    __declspec(deprecated(
        "Descriptors have increased in size (from Int16 to Int64).  Please Use "
        "descriptors2 instead")) SenUGCDescriptor descriptors[NrUgcDescriptors];
...
// This structure contains the original uploaded metadata plus any stats
// gathered from the UGC server
struct SenUGCDownloadedMetaData
{
    ...
    int nrDownloads; // automatically counts how many times MainDataBlob 0 has
                     // been downloaded
...
struct SenUGCDownloadedMetaData2
{
    ...
    SenUGCBlobMetaData
        BlobInfo[SenUGCMainData_NrBlobs]; // size and version of each blob, 0's if
                                          // not present
...
///					to bypass retrieval or retrieve specific
/// details regarding the 					Metadata stored
/// for a given Leaderboard or Leaderboard Entry.
///
