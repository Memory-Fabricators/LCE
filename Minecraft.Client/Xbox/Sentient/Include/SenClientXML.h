...
///
/// @details         This holds some easily-traversible, easily-searchible
/// representations
...
///
/// @details         It is expensive to parse an XML file directly for each
/// attribute fetch.
///                  Thus, we pre-parse the whole thing once after (down)loading
///                  it and then pass the parsed data to the fetch routines.
///
/// @related         SenXMLDestroy()
///
HRESULT SenXMLParse(const char *source, SenXML *out_senXML);

/// @brief           Free the resources/memory associated with a parsed XML
/// file.
///
/// @param[in]       senXML
...
///
/// @details         A parsed XML takes up some extra memory.  Once done with
/// its contents,
///                  you should call this routine to free it up.
///
/// @related         SenXMLParse()
///
HRESULT SenXMLDestroy(SenXML &senXML);
