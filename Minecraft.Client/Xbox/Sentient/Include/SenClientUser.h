...
///				     A single user may be in multiple roles
/// simultaneously.
///
enum SenUserRole
{
...
///                  SentientInitialize() first. E_POINTER: out_isInRole is
///                  NULL. E_FAIL: Failed to spawn server call. S_OK: Server
///                  call spawned successfully.
///
HRESULT SenUserIsInRole(int userIndex, SenUserRole role, bool *out_isInRole,
...
///                  call spawned successfully.
///
HRESULT SenUserIsInRole(PlayerUID xuid, SenUserRole role, bool *out_isInRole,
                        SenSysCompletedCallback userCallback,
                        void *userCallbackData);
} // namespace Sentient
