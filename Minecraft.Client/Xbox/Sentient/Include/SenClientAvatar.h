...
///
/// @details         This structure contains additional data about the avatar,
/// such as localized strings and palettes.
///
struct SenAvatarExtraInfo
{
    wchar_t title[XMARKETPLACE_MAX_TITLE_NAME_LENGTH +
                  1]; ///< The localized game title associated with the avatar.
    wchar_t name[XMARKETPLACE_MAX_OFFER_NAME_LENGTH +
                 1]; ///< The localized name associated with the avatar.
...
/// @brief           Search the database for all the avatars that match the
/// search criteria.
///
/// @param[in]       userIndex
...
///                  The number of SenAvatarInfo structures available in @a
///                  out_avatarInfoList.
///
...
///                  this call. E_POINTER: out_avatarInfoList is NULL. E_FAIL:
...
///
HRESULT SenAvatarEnumerate(int userIndex, size_t avatarInfoCountMax,
...
/// @brief           Search the database for a specific avatar at the current
/// time
///
/// @param[in]       titleID
///                  The ID of the title that the avatar item is associated
///                  with.
///
/// @param[in]       resourceID
///                  The ID of the specific asset about which information should
///                  be returned.
///
/// @param[out]      out_avatarInfo
///                  The structures to fill in with the information.
///                  It is assumed that this is preallocated to at least 1
///                  entry.
///
/// @param[in]       userCallback
///                  If this call returns a success code, the userCallback will
...
///                  SentientInitialize() first.
///                  SENTIENT_E_GUEST_ACCESS_VIOLATION: A guest may not spawn
///                  this call. E_POINTER: out_avatarInfo is NULL. E_FAIL:
///                  Failed to spawn server call. S_OK: Server call spawned
///                  successfully.
///
...
/// @related         SenAvatarDownloadIcon()
///
HRESULT SenAvatarFind(SenSysTitleID titleID, SenResourceID resourceID,
...
///                  asset. This is obtained from SenAvatarEnumerate().
///
/// @param[in]       male
///                  Whether or not to receive information about the male avatar
///                  (vs. the female)
///
...
///                  @a avatarInfo.[fe]male.metadata.GetBufferSize() bytes.
///
/// @param[out]      out_data
...
///                  avatarInfo.resourceID or avatarInfo.[fe]male.metadata is
///                  invalid. E_POINTER: out_data is NULL. E_FAIL: Failed to
///                  spawn server call. S_OK: Server call spawned successfully.
///
/// @related         SenAvatarEnumerate()
/// @related         SenAvatarDownloadExtraInfo()
/// @related         SenAvatarDownloadAssets()
/// @related         SenAvatarDownloadIcon()
///
HRESULT SenAvatarDownloadMetadata(const SenAvatarInfo &avatarInfo, bool male,
...
///                  out_data. If the actual size of the data exceeds this, you
///                  will receive an error. It is assumed that this is at least
///                  @a avatarInfo.[fe]male.assets.GetBufferSize() bytes.
///
/// @param[out]      out_data
...
///                  SENTIENT_E_NOT_INITIALIZED: You did not call
///                  SentientInitialize() first. E_INVALIDARG:
///                  avatarInfo.resourceID or avatarInfo.[fe]male.assets is
///                  invalid. E_POINTER: out_data is NULL. E_FAIL: Failed to
///                  spawn server call. S_OK: Server call spawned successfully.
///
/// @related         SenAvatarEnumerate()
...
/// @related         SenAvatarDownloadIcon()
///
HRESULT SenAvatarDownloadAssets(const SenAvatarInfo &avatarInfo, bool male,
                                size_t dataSizeMax, void *out_data,
                                SenSysCompletedCallback userCallback,
                                void *userCallbackData);
...
///                  out_data. If the actual size of the data exceeds this, you
///                  will receive an error. It is assumed that this is at least
///                  @a avatarInfo.[fe]male.icon.GetBufferSize() bytes.
///
/// @param[out]      out_data
...
///                  SENTIENT_E_NOT_INITIALIZED: You did not call
///                  SentientInitialize() first. E_INVALIDARG:
///                  avatarInfo.resourceID or avatarInfo.[fe]male.icon is
///                  invalid. E_POINTER: out_data is NULL. E_FAIL: Failed to
///                  spawn server call. S_OK: Server call spawned successfully.
///
/// @related         SenAvatarEnumerate()
...
/// @related         SenAvatarDownloadAssets()
///
HRESULT SenAvatarDownloadIcon(const SenAvatarInfo &avatarInfo, bool male,
                              size_t dataSizeMax, void *out_data,
                              SenSysCompletedCallback userCallback,
                              void *userCallbackData);

/// @brief           Download extra information about a given avatar to the
/// client.
///
/// @param[in]       avatarInfo
///                  The info describing the attributes and data of the avatar.
...
///                  SENTIENT_E_NOT_INITIALIZED: You did not call
///                  SentientInitialize() first. E_INVALIDARG:
///                  avatarInfo.resourceID or avatarInfo.xml is invalid.
...
/// @related         SenAvatarDownloadIcon()
///
HRESULT SenAvatarDownloadExtraInfo(const SenAvatarInfo &avatarInfo, bool male,
...
// which in turn should be at least avatarInfo.[fe]male.xml.GetBufferSize()
// bytes.
HRESULT SenAvatarDownloadXML(const SenAvatarInfo &avatarInfo, bool male,
                             size_t dataSizeMax, void *out_data,
                             SenSysCompletedCallback userCallback,
                             void *userCallbackData);
...
//
HRESULT SenAvatarXMLGetTitle(const SenXML &senXML, size_t bufferLengthMax,
...
HRESULT SenAvatarXMLGetName(const SenXML &senXML, size_t bufferLengthMax,
                            size_t *out_bufferLength, // optional
                            wchar_t *out_buffer);     // optional

// Obtain a wide, localized string with a given avatar's description.
// See the similar SenAvatarGetTitle() for details.
HRESULT SenAvatarXMLGetDescription(const SenXML &senXML, size_t bufferLengthMax,
                                   size_t *out_bufferLength, // optional
                                   wchar_t *out_buffer);     // optional

// Obtain the number of custom avatar palettes.
HRESULT SenAvatarXMLGetPaletteCount(const SenXML &senXML,
                                    size_t *out_paletteCount);

// Obtain the localized name for an avatar palettes.
// See the similar SenAvatarGetTitle() for details.
HRESULT SenAvatarXMLGetPaletteName(const SenXML &senXML, int paletteIndex,
...
// for a given avatar.
HRESULT SenAvatarXMLGetPalette(const SenXML &senXML, int paletteIndex,
...
HRESULT SenAvatarXMLGetPalettes(const SenXML &senXML, size_t paletteCountMax,
