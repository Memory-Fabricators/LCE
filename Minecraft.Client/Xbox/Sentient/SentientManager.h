...
class CSentientManager : public CTelemetryManager
{
  public:
    ...
    virtual BOOL RecordLevelStart(DWORD dwUserId,
                                  ESen_FriendOrMatch friendsOrMatch,
                                  ESen_CompeteOrCoop competeOrCoop,
                                  int difficulty, DWORD numberOfLocalPlayers,
                                  DWORD numberOfOnlinePlayers);
    virtual BOOL RecordLevelExit(DWORD dwUserId,
                                 ESen_LevelExitStatus levelExitStatus);
    virtual BOOL RecordLevelSaveOrCheckpoint(DWORD dwUserId,
                                             INT saveOrCheckPointID,
                                             INT saveSizeInBytes);
    virtual BOOL RecordLevelResume(DWORD dwUserId,
                                   ESen_FriendOrMatch friendsOrMatch,
                                   ESen_CompeteOrCoop competeOrCoop,
                                   int difficulty, DWORD numberOfLocalPlayers,
                                   DWORD numberOfOnlinePlayers,
    ...
    virtual BOOL RecordMenuShown(DWORD dwUserId, INT menuID,
                                 INT optionalMenuSubID);
    virtual BOOL RecordAchievementUnlocked(DWORD dwUserId, INT achievementID,
                                           INT achievementGamerscore);
    virtual BOOL RecordMediaShareUpload(DWORD dwUserId,
                                        ESen_MediaDestination mediaDestination,
                                        ESen_MediaType mediaType);
    virtual BOOL RecordUpsellPresented(DWORD dwUserId, ESen_UpsellID upsellId,
                                       INT marketplaceOfferID);
    virtual BOOL RecordUpsellResponded(DWORD dwUserId, ESen_UpsellID upsellId,
                                       INT marketplaceOfferID,
                                       ESen_UpsellOutcome upsellOutcome);
    virtual BOOL RecordPlayerDiedOrFailed(DWORD dwUserId, INT lowResMapX,
                                          INT lowResMapY, INT lowResMapZ,
                                          INT mapID, INT playerWeaponID,
                                          INT enemyWeaponID,
                                          ETelemetryChallenges enemyTypeID);
    virtual BOOL RecordEnemyKilledOrOvercome(DWORD dwUserId, INT lowResMapX,
                                             INT lowResMapY, INT lowResMapZ,
                                             INT mapID, INT playerWeaponID,
                                             INT enemyWeaponID,
                                             ETelemetryChallenges enemyTypeID);
    virtual BOOL RecordTexturePackLoaded(DWORD dwUserId, INT texturePackId,
                                         INT purchased);
