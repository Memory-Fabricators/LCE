                                 ...
                                 int dataSize, bool lowPriority)
{
    ...
    m_qnetPlayer->SendData(((NetworkPlayerXbox *)player)->m_qnetPlayer, pvData,
                           dataSize, flags);
}
...
bool NetworkPlayerXbox::IsSameSystem(INetworkPlayer *player)
{
    return (m_qnetPlayer->IsSameSystem(
                ((NetworkPlayerXbox *)player)->m_qnetPlayer) == TRUE);
}
                                             ...
                                             bool lowPriority)
{
    ...
    return m_qnetPlayer->GetSendQueueSize(
        player ? ((NetworkPlayerXbox *)player)->m_qnetPlayer : NULL, flags);
}
