...
class ConsoleUIController : public IUIController
{
  public:
    ...
    virtual bool NavigateToScene(int iPad, EUIScene scene, void *initData = NULL,
    ...
    virtual void SetTooltips(unsigned int iPad, int iA, int iB = -1, int iX = -1,
                             int iY = -1, int iLT = -1, int iRT = -1,
                             int iLB = -1, int iRB = -1, int iLS = -1,
