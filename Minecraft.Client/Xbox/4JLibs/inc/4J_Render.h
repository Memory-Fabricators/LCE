  ...
  public:
    ...
    typedef enum
    {
        VERTEX_TYPE_PF3_TF2_CB4_NB4_XW1,        // Position 3 x float, texture 2 x float,
                                                ...
                                                // padding 1 DWORD
        VERTEX_TYPE_PS3_TS2_CS1,                // Position 3 x short, texture 2 x short, colour 4
                                                // x byte, padding 1 DWORD
    ...
    void DrawVertices(D3DPRIMITIVETYPE PrimitiveType, int count, void *dataIn,
                      eVertexType vType, C4JRender::ePixelShaderType psType);
    void DrawVertexBuffer(D3DPRIMITIVETYPE PrimitiveType, int count,
    ...
    typedef enum
    {
        ...
        TEXTURE_FORMAT_R0G0B0Ax, // One 8-bit component mapped to alpha channel,
                                 // R=G=B=0
        TEXTURE_FORMAT_R1G1B1Ax, // One 8-bit component mapped to alpha channel,
                                 // R=G=B=1
