...
class LocalPlayer : public Player
{
  ...
  public:
    ...
    {
        return m_uiInactiveTicks;
    }
    void IncrementInactiveTicks()
    {
        if (m_uiInactiveTicks < 255)
        {
            m_uiInactiveTicks++;
        }
    }
    ...
    void SetPlayerRespawned(bool bVal)
    {
        m_bPlayerRespawned = bVal;
    }
    bool GetPlayerRespawned()
    {
        return m_bPlayerRespawned;
    }
