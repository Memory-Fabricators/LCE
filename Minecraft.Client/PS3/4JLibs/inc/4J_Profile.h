...
class C_4JProfile
{
  public:
    ...
    void InitialiseTrophies(const SceNpCommunicationId *commsId,
                            const SceNpCommunicationSignature *commsSig);
    ...
    // Debug
    //	void				SetDebugFullOverride(bool bVal); // To
    // override the license version (trail/full). Only in debug/release, not
    // ContentPackage
