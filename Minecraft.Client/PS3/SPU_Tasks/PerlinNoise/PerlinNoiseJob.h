...
class PerlinNoise_DataIn
{
  public:
    ...
    void set(PerlinNoise *pNoise, doubleArray &buffer, int x, int y, int z,
    ...
    void set(PerlinNoise *pNoise, doubleArray &buffer, int x, int z, int xSize,
             int zSize, double xScale, double zScale, double pow)
    {
