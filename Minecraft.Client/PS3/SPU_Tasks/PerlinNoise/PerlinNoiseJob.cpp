                           ...
                           CellSpursJob256 *pJob)
{
    ...
    dataIn.m_perlinData.getRegion(
        dataIn.m_outputBuffer, dataIn.x, dataIn.y, dataIn.z, dataIn.xSize,
        dataIn.ySize, dataIn.zSize, dataIn.xScale, dataIn.yScale, dataIn.zScale);
