  ...
  public:
    ...
    void updateShape(ChunkRebuildData *level, int x, int y, int z)
    {
        ...
        case Facing::UP:
            ...
            break;
        case Facing::NORTH:
            setShape(4.0f / 16.0f, 4.0f / 16.0f, .5f, 12.0f / 16.0f, 12.0f / 16.0f,
                     1);
            break;
        case Facing::SOUTH:
            setShape(4.0f / 16.0f, 4.0f / 16.0f, 0, 12.0f / 16.0f, 12.0f / 16.0f,
                     .5f);
            break;
        case Facing::WEST:
    ...
    {
        return TileRef_SPU(hellSand_Id)->getTexture(face);
    }
};
