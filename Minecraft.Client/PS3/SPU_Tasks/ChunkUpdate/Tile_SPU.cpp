                               ...
                               int face)
{
    ...
    // another change in  Level::isSolidRenderTile/Region::isSolidRenderTile which
    // makes things solid code-wise (ie for determining visible sides of
    // neighbouring blocks). This change just makes the texture a solid one (tex +
    // 1) which we already have in the texture map for doing non-fancy graphics.
    // Note: this tile-specific code is here rather than making some new virtual
    // method in the tiles, for the sake of efficiency - I don't imagine we'll be
    // doing much more of this sort of thing
...
// 		if (type <= 0) continue;
//
// 		popResource(level, x, y, z, shared_ptr<ItemInstance>( new
...
// 	shared_ptr<ItemEntity> item = shared_ptr<ItemEntity>( new
...
// newCount; 			level->addEntity(shared_ptr<ExperienceOrb>( new
...
// }
//
// bool Tile_SPU::TestUse(Level *level, int x, int y, int z, shared_ptr<Player>
// player)
// {
// 	return false;
// }
//
// bool Tile_SPU::use(Level *level, int x, int y, int z, shared_ptr<Player>
...
// }
//
// void Tile_SPU::stepOn(Level *level, int x, int y, int z, shared_ptr<Entity>
// entity)
// {
// }
//
...
// }
//
// void Tile_SPU::attack(Level *level, int x, int y, int z, shared_ptr<Player>
// player)
// {
// }
//
// void Tile_SPU::handleEntityInside(Level *level, int x, int y, int z,
// shared_ptr<Entity> e, Vec3 *current)
// {
// }
//
...
//
// void Tile_SPU::playerDestroy(Level *level, shared_ptr<Player> player, int x,
...
// }
//
// void Tile_SPU::setPlacedBy(Level *level, int x, int y, int z, shared_ptr<Mob>
// by)
// {
// }
//
...
//
// void Tile_SPU::fallOn(Level *level, int x, int y, int z, shared_ptr<Entity>
// entity, float fallDistance)
// {
// }
//
