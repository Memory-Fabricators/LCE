...
void StairTile_SPU::updateShape(
...
bool StairTile_SPU::isLockAttached(ChunkRebuildData *level, int x, int y, int z,
                                   int data)
{
 ...
 * "inner corner."
 */
bool StairTile_SPU::setInnerPieceShape(ChunkRebuildData *level, int x, int y,
                                       int z)
{
    int data = level->getData(x, y, z);
    int dir = data & 0x3;
