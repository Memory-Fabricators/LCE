...
void TextureDataUpdate(int xoffset, int yoffset, int width, int height,
                       int pitch, void *pSrcData, void *pDstData, int level)
{
    int colourDepth = 4;
                           ...
                           CellSpursJob256 *pJob)
{
    ...
    DmaData_SPU::getAndWait(&dataIn, eaDataIn,
                            sizeof(Renderer_TextureUpdate_DataIn));
    ...
    TextureDataUpdate(dataIn.xoffset, dataIn.yoffset, dataIn.width, dataIn.height,
                      dataIn.pitch, dataIn.pSrcData, dataIn.pDstData,
                      dataIn.level);
