...
void zSort(LevelRenderer_cull_DataIn *dataIn,
           LevelRenderer_cull_DataIn *eaDataIn)
{
    int num = dataIn->numToRender_layer0;
    int *listArray_layer0 =
        (int *)alloca(DmaData_SPU::roundUpDMASize(num * sizeof(int)));
    float *zDepth_layer0 =
        (float *)alloca(DmaData_SPU::roundUpDMASize(num * sizeof(float)));
    ListData *list =
        (ListData *)alloca(DmaData_SPU::roundUpDMASize(num * sizeof(ListData)));
    DmaData_SPU::getAndWait(listArray_layer0, (uintptr_t)dataIn->listArray_layer0,
                            DmaData_SPU::roundUpDMASize(sizeof(int) * num));
    DmaData_SPU::getAndWait(zDepth_layer0, (uintptr_t)dataIn->zDepth_layer0,
                            DmaData_SPU::roundUpDMASize(sizeof(int) * num));
    ...
    DmaData_SPU::putAndWait(listArray_layer0, (uintptr_t)dataIn->listArray_layer0,
                            DmaData_SPU::roundUpDMASize(sizeof(int) * num));
    DmaData_SPU::putAndWait(zDepth_layer0, (uintptr_t)dataIn->zDepth_layer0,
                            DmaData_SPU::roundUpDMASize(sizeof(float) * num));
}
