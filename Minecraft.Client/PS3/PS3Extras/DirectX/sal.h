...
#if _USE_DECLSPECS_FOR_SAL && (defined(MIDL_PASS) || defined(__midl) || \
...
#if defined(_MSC_EXTENSIONS) && !defined(MIDL_PASS) && !defined(__midl) && \
    !defined(RC_INVOKED)
...
#define _Out_opt_z_cap_m_(mult, size) \
    _Pre_opt_cap_m_(mult, size) _Pre_invalid_ _Post_z_
...
#define _Out_opt_z_bytecap_c_(size) \
    _Pre_opt_bytecap_c_(size) _Pre_invalid_ _Post_z_
...
#define _Out_opt_z_bytecap_x_(size) \
    _Pre_opt_bytecap_x_(size) _Pre_invalid_ _Post_z_
...
#define _Out_cap_post_count_(cap, count) \
    _Pre_cap_(cap) _Pre_invalid_ _Post_count_(count)
#define _Out_opt_cap_post_count_(cap, count) \
    _Pre_opt_cap_(cap) _Pre_invalid_ _Post_count_(count)
#define _Out_bytecap_post_bytecount_(cap, count) \
    _Pre_bytecap_(cap) _Pre_invalid_ _Post_bytecount_(count)
#define _Out_opt_bytecap_post_bytecount_(cap, count) \
    _Pre_opt_bytecap_(cap) _Pre_invalid_ _Post_bytecount_(count)
...
#define _Out_z_cap_post_count_(cap, count) \
    _Pre_cap_(cap) _Pre_invalid_ _Post_z_count_(count)
#define _Out_opt_z_cap_post_count_(cap, count) \
    _Pre_opt_cap_(cap) _Pre_invalid_ _Post_z_count_(count)
#define _Out_z_bytecap_post_bytecount_(cap, count) \
    _Pre_bytecap_(cap) _Pre_invalid_ _Post_z_bytecount_(count)
#define _Out_opt_z_bytecap_post_bytecount_(cap, count) \
    _Pre_opt_bytecap_(cap) _Pre_invalid_ _Post_z_bytecount_(count)

// only use with dereferenced arguments e.g. '*pcch'
#define _Out_capcount_(capcount) \
    _Pre_cap_(capcount) _Pre_invalid_ _Post_count_(capcount)
#define _Out_opt_capcount_(capcount) \
    _Pre_opt_cap_(capcount) _Pre_invalid_ _Post_count_(capcount)
#define _Out_bytecapcount_(capcount) \
    _Pre_bytecap_(capcount) _Pre_invalid_ _Post_bytecount_(capcount)
#define _Out_opt_bytecapcount_(capcount) \
    _Pre_opt_bytecap_(capcount) _Pre_invalid_ _Post_bytecount_(capcount)

#define _Out_capcount_x_(capcount) \
    _Pre_cap_x_(capcount) _Pre_invalid_ _Post_count_x_(capcount)
#define _Out_opt_capcount_x_(capcount) \
    _Pre_opt_cap_x_(capcount) _Pre_invalid_ _Post_count_x_(capcount)
#define _Out_bytecapcount_x_(capcount) \
    _Pre_bytecap_x_(capcount) _Pre_invalid_ _Post_bytecount_x_(capcount)
#define _Out_opt_bytecapcount_x_(capcount) \
    _Pre_opt_bytecap_x_(capcount) _Pre_invalid_ _Post_bytecount_x_(capcount)

// e.g. GetString( _Out_z_capcount_(*pLen+1) char* sz, size_t* pLen );
#define _Out_z_capcount_(capcount) \
    _Pre_cap_(capcount) _Pre_invalid_ _Post_z_count_(capcount)
#define _Out_opt_z_capcount_(capcount) \
    _Pre_opt_cap_(capcount) _Pre_invalid_ _Post_z_count_(capcount)
#define _Out_z_bytecapcount_(capcount) \
    _Pre_bytecap_(capcount) _Pre_invalid_ _Post_z_bytecount_(capcount)
#define _Out_opt_z_bytecapcount_(capcount) \
    _Pre_opt_bytecap_(capcount) _Pre_invalid_ _Post_z_bytecount_(capcount)
...
// e.g. void ModifyIndices( _Inout_count_(cIndices) int* rgIndeces, size_t
// cIndices );
...
// call e.g. void ModifyIndices( _Inout_count_(cIndices) int* rgIndeces, size_t
// cIndices );
...
#define _Pre_opt_ptrdiff_cap_(ptr) \
    _Pre2_impl_(_$maybenull, _$cap_x(__ptrdiff(ptr)))

// e.g. void AppendStr( _Pre_z_ const char* szFrom, _Pre_z_cap_(cchTo) _Post_z_
// char* szTo, size_t cchTo );
#define _Pre_z_cap_(size) \
    _Pre3_impl_(_$notnull, _$zterm, _$cap(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_z_cap_(size) \
    _Pre3_impl_(_$maybenull, _$zterm, _$cap(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_z_bytecap_(size) \
    _Pre3_impl_(_$notnull, _$zterm, _$bytecap(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_z_bytecap_(size) \
    _Pre3_impl_(_$maybenull, _$zterm, _$bytecap(size)) _Deref_pre1_impl_(_$valid)

#define _Pre_z_cap_c_(size) \
    _Pre3_impl_(_$notnull, _$zterm, _$cap_c(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_z_cap_c_(size) \
    _Pre3_impl_(_$maybenull, _$zterm, _$cap_c(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_z_bytecap_c_(size) \
    _Pre3_impl_(_$notnull, _$zterm, _$bytecap_c(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_z_bytecap_c_(size)                      \
    _Pre3_impl_(_$maybenull, _$zterm, _$bytecap_c(size)) \
        _Deref_pre1_impl_(_$valid)

#define _Pre_z_cap_x_(size) \
    _Pre3_impl_(_$notnull, _$zterm, _$cap_x(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_z_cap_x_(size) \
    _Pre3_impl_(_$maybenull, _$zterm, _$cap_x(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_z_bytecap_x_(size) \
    _Pre3_impl_(_$notnull, _$zterm, _$bytecap_x(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_z_bytecap_x_(size)                      \
    _Pre3_impl_(_$maybenull, _$zterm, _$bytecap_x(size)) \
        _Deref_pre1_impl_(_$valid)

// known capacity and valid but unknown readable extent
#define _Pre_valid_cap_(size) \
    _Pre2_impl_(_$notnull, _$cap(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_valid_cap_(size) \
    _Pre2_impl_(_$maybenull, _$cap(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_valid_bytecap_(size) \
    _Pre2_impl_(_$notnull, _$bytecap(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_valid_bytecap_(size) \
    _Pre2_impl_(_$maybenull, _$bytecap(size)) _Deref_pre1_impl_(_$valid)

#define _Pre_valid_cap_c_(size) \
    _Pre2_impl_(_$notnull, _$cap_c(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_valid_cap_c_(size) \
    _Pre2_impl_(_$maybenull, _$cap_c(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_valid_bytecap_c_(size) \
    _Pre2_impl_(_$notnull, _$bytecap_c(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_valid_bytecap_c_(size) \
    _Pre2_impl_(_$maybenull, _$bytecap_c(size)) _Deref_pre1_impl_(_$valid)

#define _Pre_valid_cap_x_(size) \
    _Pre2_impl_(_$notnull, _$cap_x(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_valid_cap_x_(size) \
    _Pre2_impl_(_$maybenull, _$cap_x(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_valid_bytecap_x_(size) \
    _Pre2_impl_(_$notnull, _$bytecap_x(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_valid_bytecap_x_(size) \
    _Pre2_impl_(_$maybenull, _$bytecap_x(size)) _Deref_pre1_impl_(_$valid)
...
#define _Pre_count_(size) \
    _Pre2_impl_(_$notnull, _$count(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_count_(size) \
    _Pre2_impl_(_$maybenull, _$count(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_bytecount_(size) \
    _Pre2_impl_(_$notnull, _$bytecount(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_bytecount_(size) \
    _Pre2_impl_(_$maybenull, _$bytecount(size)) _Deref_pre1_impl_(_$valid)

// Valid buffer extent described by a constant expression
#define _Pre_count_c_(size) \
    _Pre2_impl_(_$notnull, _$count_c(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_count_c_(size) \
    _Pre2_impl_(_$maybenull, _$count_c(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_bytecount_c_(size) \
    _Pre2_impl_(_$notnull, _$bytecount_c(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_bytecount_c_(size) \
    _Pre2_impl_(_$maybenull, _$bytecount_c(size)) _Deref_pre1_impl_(_$valid)

// Valid buffer extent described by a complex expression
#define _Pre_count_x_(size) \
    _Pre2_impl_(_$notnull, _$count_x(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_count_x_(size) \
    _Pre2_impl_(_$maybenull, _$count_x(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_bytecount_x_(size) \
    _Pre2_impl_(_$notnull, _$bytecount_x(size)) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_bytecount_x_(size) \
    _Pre2_impl_(_$maybenull, _$bytecount_x(size)) _Deref_pre1_impl_(_$valid)

// Valid buffer extent described by the difference to another pointer parameter
#define _Pre_ptrdiff_count_(ptr) \
    _Pre2_impl_(_$notnull, _$count_x(__ptrdiff(ptr))) _Deref_pre1_impl_(_$valid)
#define _Pre_opt_ptrdiff_count_(ptr) \
    _Pre2_impl_(_$maybenull, _$count_x(__ptrdiff(ptr))) _Deref_pre1_impl_(_$valid)
...
#define _Post_count_(size) \
    _Post1_impl_(_$count(size)) _Deref_post1_impl_(_$valid)
#define _Post_bytecount_(size) \
    _Post1_impl_(_$bytecount(size)) _Deref_post1_impl_(_$valid)
#define _Post_count_c_(size) \
    _Post1_impl_(_$count_c(size)) _Deref_post1_impl_(_$valid)
#define _Post_bytecount_c_(size) \
    _Post1_impl_(_$bytecount_c(size)) _Deref_post1_impl_(_$valid)
#define _Post_count_x_(size) \
    _Post1_impl_(_$count_x(size)) _Deref_post1_impl_(_$valid)
#define _Post_bytecount_x_(size) \
    _Post1_impl_(_$bytecount_x(size)) _Deref_post1_impl_(_$valid)
...
#define _Post_z_count_(size) \
    _Post2_impl_(_$zterm, _$count(size)) _Deref_post1_impl_(_$valid)
#define _Post_z_bytecount_(size) \
    _Post2_impl_(_$zterm, _$bytecount(size)) _Deref_post1_impl_(_$valid)
#define _Post_z_count_c_(size) \
    _Post2_impl_(_$zterm, _$count_c(size)) _Deref_post1_impl_(_$valid)
#define _Post_z_bytecount_c_(size) \
    _Post2_impl_(_$zterm, _$bytecount_c(size)) _Deref_post1_impl_(_$valid)
#define _Post_z_count_x_(size) \
    _Post2_impl_(_$zterm, _$count_x(size)) _Deref_post1_impl_(_$valid)
#define _Post_z_bytecount_x_(size) \
    _Post2_impl_(_$zterm, _$bytecount_x(size)) _Deref_post1_impl_(_$valid)
...
#define _Ret_z_cap_(size) \
    _Ret3_impl_(_$notnull, _$zterm, _$cap(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_opt_z_cap_(size) \
    _Ret3_impl_(_$maybenull, _$zterm, _$cap(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_z_bytecap_(size) \
    _Ret3_impl_(_$notnull, _$zterm, _$bytecap(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_opt_z_bytecap_(size) \
    _Ret3_impl_(_$maybenull, _$zterm, _$bytecap(size)) _Deref_ret1_impl_(_$valid)

// e.g. _Ret_opt_bytecount_(cb) void* AllocateZeroInitializedMemory( size_t cb
// ); Valid Buffer extent is described by another parameter
#define _Ret_count_(size) \
    _Ret2_impl_(_$notnull, _$count(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_opt_count_(size) \
    _Ret2_impl_(_$maybenull, _$count(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_bytecount_(size) \
    _Ret2_impl_(_$notnull, _$bytecount(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_opt_bytecount_(size) \
    _Ret2_impl_(_$maybenull, _$bytecount(size)) _Deref_ret1_impl_(_$valid)

// Valid Buffer extent is described by a constant expression
#define _Ret_count_c_(size) \
    _Ret2_impl_(_$notnull, _$count_c(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_opt_count_c_(size) \
    _Ret2_impl_(_$maybenull, _$count_c(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_bytecount_c_(size) \
    _Ret2_impl_(_$notnull, _$bytecount_c(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_opt_bytecount_c_(size) \
    _Ret2_impl_(_$maybenull, _$bytecount_c(size)) _Deref_ret1_impl_(_$valid)

// Valid Buffer extent is described by a complex expression
#define _Ret_count_x_(size) \
    _Ret2_impl_(_$notnull, _$count_x(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_opt_count_x_(size) \
    _Ret2_impl_(_$maybenull, _$count_x(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_bytecount_x_(size) \
    _Ret2_impl_(_$notnull, _$bytecount_x(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_opt_bytecount_x_(size) \
    _Ret2_impl_(_$maybenull, _$bytecount_x(size)) _Deref_ret1_impl_(_$valid)

// return value is nullterminated and length is given by another parameter
#define _Ret_z_count_(size) \
    _Ret3_impl_(_$notnull, _$zterm, _$count(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_opt_z_count_(size) \
    _Ret3_impl_(_$maybenull, _$zterm, _$count(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_z_bytecount_(size) \
    _Ret3_impl_(_$notnull, _$zterm, _$bytecount(size)) _Deref_ret1_impl_(_$valid)
#define _Ret_opt_z_bytecount_(size)                      \
    _Ret3_impl_(_$maybenull, _$zterm, _$bytecount(size)) \
        _Deref_ret1_impl_(_$valid)
...
#define _Deref_pre_z_ \
    _Deref_pre2_impl_(_$notnull, _$zterm) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_z_ \
    _Deref_pre2_impl_(_$maybenull, _$zterm) _Deref2_pre1_impl_(_$valid)
...
#define _Deref_pre_opt_bytecap_(size) \
    _Deref_pre2_impl_(_$maybenull, _$bytecap(size))

// buffer capacity is described by a constant expression
#define _Deref_pre_cap_c_(size) _Deref_pre2_impl_(_$notnull, _$cap_c(size))
#define _Deref_pre_opt_cap_c_(size) \
    _Deref_pre2_impl_(_$maybenull, _$cap_c(size))
#define _Deref_pre_bytecap_c_(size) \
    _Deref_pre2_impl_(_$notnull, _$bytecap_c(size))
#define _Deref_pre_opt_bytecap_c_(size) \
    _Deref_pre2_impl_(_$maybenull, _$bytecap_c(size))

// buffer capacity is described by a complex condition
#define _Deref_pre_cap_x_(size) _Deref_pre2_impl_(_$notnull, _$cap_x(size))
#define _Deref_pre_opt_cap_x_(size) \
    _Deref_pre2_impl_(_$maybenull, _$cap_x(size))
#define _Deref_pre_bytecap_x_(size) \
    _Deref_pre2_impl_(_$notnull, _$bytecap_x(size))
#define _Deref_pre_opt_bytecap_x_(size) \
    _Deref_pre2_impl_(_$maybenull, _$bytecap_x(size))

// convenience macros for nullterminated buffers with given capacity
#define _Deref_pre_z_cap_(size) \
    _Deref_pre3_impl_(_$notnull, _$zterm, _$cap(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_z_cap_(size)                      \
    _Deref_pre3_impl_(_$maybenull, _$zterm, _$cap(size)) \
        _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_z_bytecap_(size)                        \
    _Deref_pre3_impl_(_$notnull, _$zterm, _$bytecap(size)) \
        _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_z_bytecap_(size)                      \
    _Deref_pre3_impl_(_$maybenull, _$zterm, _$bytecap(size)) \
        _Deref2_pre1_impl_(_$valid)

#define _Deref_pre_z_cap_c_(size)                        \
    _Deref_pre3_impl_(_$notnull, _$zterm, _$cap_c(size)) \
        _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_z_cap_c_(size)                      \
    _Deref_pre3_impl_(_$maybenull, _$zterm, _$cap_c(size)) \
        _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_z_bytecap_c_(size)                        \
    _Deref_pre3_impl_(_$notnull, _$zterm, _$bytecap_c(size)) \
        _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_z_bytecap_c_(size)                      \
    _Deref_pre3_impl_(_$maybenull, _$zterm, _$bytecap_c(size)) \
        _Deref2_pre1_impl_(_$valid)

#define _Deref_pre_z_cap_x_(size)                        \
    _Deref_pre3_impl_(_$notnull, _$zterm, _$cap_x(size)) \
        _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_z_cap_x_(size)                      \
    _Deref_pre3_impl_(_$maybenull, _$zterm, _$cap_x(size)) \
        _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_z_bytecap_x_(size)                        \
    _Deref_pre3_impl_(_$notnull, _$zterm, _$bytecap_x(size)) \
        _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_z_bytecap_x_(size)                      \
    _Deref_pre3_impl_(_$maybenull, _$zterm, _$bytecap_x(size)) \
        _Deref2_pre1_impl_(_$valid)

// known capacity and valid but unknown readable extent
#define _Deref_pre_valid_cap_(size) \
    _Deref_pre2_impl_(_$notnull, _$cap(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_valid_cap_(size) \
    _Deref_pre2_impl_(_$maybenull, _$cap(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_valid_bytecap_(size) \
    _Deref_pre2_impl_(_$notnull, _$bytecap(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_valid_bytecap_(size) \
    _Deref_pre2_impl_(_$maybenull, _$bytecap(size)) _Deref2_pre1_impl_(_$valid)

#define _Deref_pre_valid_cap_c_(size) \
    _Deref_pre2_impl_(_$notnull, _$cap_c(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_valid_cap_c_(size) \
    _Deref_pre2_impl_(_$maybenull, _$cap_c(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_valid_bytecap_c_(size) \
    _Deref_pre2_impl_(_$notnull, _$bytecap_c(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_valid_bytecap_c_(size) \
    _Deref_pre2_impl_(_$maybenull, _$bytecap_c(size)) _Deref2_pre1_impl_(_$valid)

#define _Deref_pre_valid_cap_x_(size) \
    _Deref_pre2_impl_(_$notnull, _$cap_x(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_valid_cap_x_(size) \
    _Deref_pre2_impl_(_$maybenull, _$cap_x(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_valid_bytecap_x_(size) \
    _Deref_pre2_impl_(_$notnull, _$bytecap_x(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_valid_bytecap_x_(size) \
    _Deref_pre2_impl_(_$maybenull, _$bytecap_x(size)) _Deref2_pre1_impl_(_$valid)
...
#define _Deref_pre_count_(size) \
    _Deref_pre2_impl_(_$notnull, _$count(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_count_(size) \
    _Deref_pre2_impl_(_$maybenull, _$count(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_bytecount_(size) \
    _Deref_pre2_impl_(_$notnull, _$bytecount(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_bytecount_(size) \
    _Deref_pre2_impl_(_$maybenull, _$bytecount(size)) _Deref2_pre1_impl_(_$valid)

// valid buffer extent is described by a constant expression
#define _Deref_pre_count_c_(size) \
    _Deref_pre2_impl_(_$notnull, _$count_c(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_count_c_(size) \
    _Deref_pre2_impl_(_$maybenull, _$count_c(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_bytecount_c_(size) \
    _Deref_pre2_impl_(_$notnull, _$bytecount_c(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_bytecount_c_(size)               \
    _Deref_pre2_impl_(_$maybenull, _$bytecount_c(size)) \
        _Deref2_pre1_impl_(_$valid)

// valid buffer extent is described by a complex expression
#define _Deref_pre_count_x_(size) \
    _Deref_pre2_impl_(_$notnull, _$count_x(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_count_x_(size) \
    _Deref_pre2_impl_(_$maybenull, _$count_x(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_bytecount_x_(size) \
    _Deref_pre2_impl_(_$notnull, _$bytecount_x(size)) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_bytecount_x_(size)               \
    _Deref_pre2_impl_(_$maybenull, _$bytecount_x(size)) \
        _Deref2_pre1_impl_(_$valid)

// e.g. void PrintStringArray( _In_count_(cElems) _Deref_pre_valid_ LPCSTR
// rgStr[], size_t cElems );
#define _Deref_pre_valid_ \
    _Deref_pre1_impl_(_$notnull) _Deref2_pre1_impl_(_$valid)
#define _Deref_pre_opt_valid_ \
    _Deref_pre1_impl_(_$maybenull) _Deref2_pre1_impl_(_$valid)
...
#define _Deref_post_z_ \
    _Deref_post2_impl_(_$notnull, _$zterm) _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_z_ \
    _Deref_post2_impl_(_$maybenull, _$zterm) _Deref2_post1_impl_(_$valid)
...
#define _Deref_post_bytecap_(size) \
    _Deref_post2_impl_(_$notnull, _$bytecap(size))
#define _Deref_post_opt_bytecap_(size) \
    _Deref_post2_impl_(_$maybenull, _$bytecap(size))

// buffer capacity is described by a constant expression
#define _Deref_post_cap_c_(size) _Deref_post2_impl_(_$notnull, _$cap_z(size))
#define _Deref_post_opt_cap_c_(size) \
    _Deref_post2_impl_(_$maybenull, _$cap_z(size))
#define _Deref_post_bytecap_c_(size) \
    _Deref_post2_impl_(_$notnull, _$bytecap_z(size))
#define _Deref_post_opt_bytecap_c_(size) \
    _Deref_post2_impl_(_$maybenull, _$bytecap_z(size))

// buffer capacity is described by a complex expression
#define _Deref_post_cap_x_(size) _Deref_post2_impl_(_$notnull, _$cap_x(size))
#define _Deref_post_opt_cap_x_(size) \
    _Deref_post2_impl_(_$maybenull, _$cap_x(size))
#define _Deref_post_bytecap_x_(size) \
    _Deref_post2_impl_(_$notnull, _$bytecap_x(size))
#define _Deref_post_opt_bytecap_x_(size) \
    _Deref_post2_impl_(_$maybenull, _$bytecap_x(size))

// convenience macros for nullterminated buffers with given capacity
#define _Deref_post_z_cap_(size)                        \
    _Deref_post3_impl_(_$notnull, _$zterm, _$cap(size)) \
        _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_z_cap_(size)                      \
    _Deref_post3_impl_(_$maybenull, _$zterm, _$cap(size)) \
        _Deref2_post1_impl_(_$valid)
#define _Deref_post_z_bytecap_(size)                        \
    _Deref_post3_impl_(_$notnull, _$zterm, _$bytecap(size)) \
        _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_z_bytecap_(size)                      \
    _Deref_post3_impl_(_$maybenull, _$zterm, _$bytecap(size)) \
        _Deref2_post1_impl_(_$valid)

#define _Deref_post_z_cap_c_(size)                        \
    _Deref_post3_impl_(_$notnull, _$zterm, _$cap_c(size)) \
        _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_z_cap_c_(size)                      \
    _Deref_post3_impl_(_$maybenull, _$zterm, _$cap_c(size)) \
        _Deref2_post1_impl_(_$valid)
#define _Deref_post_z_bytecap_c_(size)                        \
    _Deref_post3_impl_(_$notnull, _$zterm, _$bytecap_c(size)) \
        _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_z_bytecap_c_(size)                      \
    _Deref_post3_impl_(_$maybenull, _$zterm, _$bytecap_c(size)) \
        _Deref2_post1_impl_(_$valid)

#define _Deref_post_z_cap_x_(size)                        \
    _Deref_post3_impl_(_$notnull, _$zterm, _$cap_x(size)) \
        _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_z_cap_x_(size)                      \
    _Deref_post3_impl_(_$maybenull, _$zterm, _$cap_x(size)) \
        _Deref2_post1_impl_(_$valid)
#define _Deref_post_z_bytecap_x_(size)                        \
    _Deref_post3_impl_(_$notnull, _$zterm, _$bytecap_x(size)) \
        _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_z_bytecap_x_(size)                      \
    _Deref_post3_impl_(_$maybenull, _$zterm, _$bytecap_x(size)) \
        _Deref2_post1_impl_(_$valid)

// known capacity and valid but unknown readable extent
#define _Deref_post_valid_cap_(size) \
    _Deref_post2_impl_(_$notnull, _$cap(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_valid_cap_(size) \
    _Deref_post2_impl_(_$maybenull, _$cap(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_valid_bytecap_(size) \
    _Deref_post2_impl_(_$notnull, _$bytecap(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_valid_bytecap_(size) \
    _Deref_post2_impl_(_$maybenull, _$bytecap(size)) _Deref2_post1_impl_(_$valid)

#define _Deref_post_valid_cap_c_(size) \
    _Deref_post2_impl_(_$notnull, _$cap_c(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_valid_cap_c_(size) \
    _Deref_post2_impl_(_$maybenull, _$cap_c(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_valid_bytecap_c_(size) \
    _Deref_post2_impl_(_$notnull, _$bytecap_c(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_valid_bytecap_c_(size)         \
    _Deref_post2_impl_(_$maybenull, _$bytecap_c(size)) \
        _Deref2_post1_impl_(_$valid)

#define _Deref_post_valid_cap_x_(size) \
    _Deref_post2_impl_(_$notnull, _$cap_x(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_valid_cap_x_(size) \
    _Deref_post2_impl_(_$maybenull, _$cap_x(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_valid_bytecap_x_(size) \
    _Deref_post2_impl_(_$notnull, _$bytecap_x(size)) _Deref2_post1_impl_(_$valid)
...
#define _Deref_post_count_(size) \
    _Deref_post2_impl_(_$notnull, _$count(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_count_(size) \
    _Deref_post2_impl_(_$maybenull, _$count(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_bytecount_(size) \
    _Deref_post2_impl_(_$notnull, _$bytecount(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_bytecount_(size)               \
    _Deref_post2_impl_(_$maybenull, _$bytecount(size)) \
        _Deref2_post1_impl_(_$valid)

// buffer capacity is described by a constant expression
#define _Deref_post_count_c_(size) \
    _Deref_post2_impl_(_$notnull, _$count_c(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_count_c_(size) \
    _Deref_post2_impl_(_$maybenull, _$count_c(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_bytecount_c_(size)                 \
    _Deref_post2_impl_(_$notnull, _$bytecount_c(size)) \
        _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_bytecount_c_(size)               \
    _Deref_post2_impl_(_$maybenull, _$bytecount_c(size)) \
        _Deref2_post1_impl_(_$valid)

// buffer capacity is described by a complex expression
#define _Deref_post_count_x_(size) \
    _Deref_post2_impl_(_$notnull, _$count_x(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_count_x_(size) \
    _Deref_post2_impl_(_$maybenull, _$count_x(size)) _Deref2_post1_impl_(_$valid)
#define _Deref_post_bytecount_x_(size)                 \
    _Deref_post2_impl_(_$notnull, _$bytecount_x(size)) \
        _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_bytecount_x_(size)               \
    _Deref_post2_impl_(_$maybenull, _$bytecount_x(size)) \
        _Deref2_post1_impl_(_$valid)

// e.g. void GetStrings( _Out_count_(cElems) _Deref_post_valid_ LPSTR const
// rgStr[], size_t cElems );
#define _Deref_post_valid_ \
    _Deref_post1_impl_(_$notnull) _Deref2_post1_impl_(_$valid)
#define _Deref_post_opt_valid_ \
    _Deref_post1_impl_(_$maybenull) _Deref2_post1_impl_(_$valid)
...
#define _Deref_out_z_cap_c_(size) \
    _Deref_pre_cap_c_(size) _Deref_pre_invalid_ _Deref_post_z_
#define _Deref_inout_z_cap_c_(size) _Deref_pre_z_cap_c_(size) _Deref_post_z_
#define _Deref_out_z_bytecap_c_(size) \
    _Deref_pre_bytecap_c_(size) _Deref_pre_invalid_ _Deref_post_z_
...
#define _Ret_range_impl_(min, max) \
    [returnvalue:SA_PostRange(MinVal = #min, MaxVal = #max)]
#define _Deref_in_range_impl_(min, max) \
    [SA_PreRange(Deref = 1, MinVal = #min, MaxVal = #max)]
#define _Deref_out_range_impl_(min, max) \
    [SA_PostRange(Deref = 1, MinVal = #min, MaxVal = #max)]
#define _Deref_ret_range_impl_(min, max) \
    [returnvalue:SA_PostRange(Deref = 1, MinVal = #min, MaxVal = #max)]
...
#define _Deref_ret3_impl_(p1, p2, p3) \
    [returnvalue:SA_Post(Deref = 1, p1, p2, p3)]
...
#define _$cap(size) \
    __declspec("SAL_writableTo(elementCount("_ $SPECSTRIZE(size) "))")
#define _$cap_c(size) \
    __declspec("SAL_writableTo(elementCount("_ $SPECSTRIZE(size) "))")
#define _$cap_for(param) \
    __declspec("SAL_writableTo(needsCountFor("_ $SPECSTRIZE(param) "))")
#define _$cap_x(size) \
    __declspec("SAL_writableTo(inexpressibleCount('"_ $SPECSTRIZE(size) "'))")

#define _$bytecap(size) \
    __declspec("SAL_writableTo(byteCount("_ $SPECSTRIZE(size) "))")
#define _$bytecap_c(size) \
    __declspec("SAL_writableTo(byteCount("_ $SPECSTRIZE(size) "))")
#define _$bytecap_x(size) \
    __declspec("SAL_writableTo(inexpressibleCount('"_ $SPECSTRIZE(size) "'))")

#define _$mult(mult, size)                                        \
    __declspec("SAL_writableTo(inexpressibleCount("_ $SPECSTRIZE( \
        mult) "*"_ $SPECSTRIZE(size) "))")

#define _$count(size) \
    __declspec("SAL_readableTo(elementCount("_ $SPECSTRIZE(size) "))")
#define _$count_c(size) \
    __declspec("SAL_readableTo(elementCount("_ $SPECSTRIZE(size) "))")
#define _$count_x(size) \
    __declspec("SAL_readableTo(inexpressibleCount('"_ $SPECSTRIZE(size) "'))")

#define _$bytecount(size) \
    __declspec("SAL_readableTo(byteCount("_ $SPECSTRIZE(size) "))")
#define _$bytecount_c(size) \
    __declspec("SAL_readableTo(byteCount("_ $SPECSTRIZE(size) "))")
#define _$bytecount_x(size) \
    __declspec("SAL_readableTo(inexpressibleCount('"_ $SPECSTRIZE(size) "'))")
...
#define _$range(min, max) \
    __declspec("SAL_range("_ $SPECSTRIZE(min) ","_ $SPECSTRIZE(max) ")")
...
#define _Deref_pre3_impl_(p1, p2, p3) \
    _$deref_pre p1 _$deref_pre p2 _$deref_pre p3
...
#define _Deref_post3_impl_(p1, p2, p3) \
    _$deref_post p1 _$deref_post p2 _$deref_post p3
...
#define _Deref2_ret1_impl_(p1) _$deref_post __declspec("SAL_deref") p1
    ...
    !defined(RC_INVOKED) && defined(_PFT_VER) && _MSC_VER >= 1400
...
REPEATABLE
[source_annotation_attribute(SA(Parameter))] struct _$P {
#ifdef __cplusplus
    _$P();
#endif
    int _$d;
...
REPEATABLE
[source_annotation_attribute(SA(ReturnValue))] struct _$R {
#ifdef __cplusplus
    _$R();
#endif
    int _$d;
...
[source_annotation_attribute(SA(Method))] struct _$M {
#ifdef __cplusplus
    _$M();
#endif
    int _$d;
...
/*
 ...
 LWSTDAPI_(BOOL) StrToIntExA(
     LPCSTR pszString,                    -- No annotation required, const
 implies __in. DWORD dwFlags,
 ...
 that will
     ...
     LPCSTR pszSrc,                       -- No annotation required, const
 implies __in. UINT cchMax, DWORD dwFlags
 );
...
#define __nothrow
    ...
    */
    ...
    various defect detection tools. When the regular compiler is running, they are
    defined into nothing, and do not affect the compiled code.
    */
...
#define __readableTo(extent) \
    __declspec("SAL_readableTo(" SPECSTRINGIZE(extent) ")")
...
#define __elem_readableTo(size) \
    __declspec("SAL_readableTo(elementCount(" SPECSTRINGIZE(size) "))")
...
#define __byte_readableTo(size) \
    __declspec("SAL_readableTo(byteCount(" SPECSTRINGIZE(size) "))")
...
#define __elem_writableTo(size) \
    __declspec("SAL_writableTo(elementCount(" SPECSTRINGIZE(size) "))")
...
#define __byte_writableTo(size) \
    __declspec("SAL_writableTo(byteCount(" SPECSTRINGIZE(size) "))")
...
#define __out_z_opt \
    __post __valid __refparam __post __nullterminated __exceptthat __maybenull
...
#define __inout_ecount_part(size, length) \
    __out_ecount_part(size, length) __pre __valid __pre __elem_readableTo(length)
#define __inout_bcount_part(size, length) \
    __out_bcount_part(size, length) __pre __valid __pre __byte_readableTo(length)
...
#define __inout_ecount_z(size) \
    __inout_ecount(size) __pre __nullterminated __post __nullterminated
...
#define __out_ecount_full_opt(size) \
    __out_ecount_full(size) __exceptthat __maybenull
#define __out_bcount_full_opt(size) \
    __out_bcount_full(size) __exceptthat __maybenull
...
#define __inout_ecount_full_opt(size) \
    __inout_ecount_full(size) __exceptthat __maybenull
#define __inout_bcount_full_opt(size) \
    __inout_bcount_full(size) __exceptthat __maybenull
...
#define __deref_ecount(size)                    \
    __ecount(1) __post __elem_readableTo(1)     \
        __post __deref __notnull __post __deref \
        __elem_writableTo(size)
...
#define __deref_out_ecount(size) \
    __deref_ecount(size) __post __deref __valid __refparam
#define __deref_out_bcount(size) \
    __deref_bcount(size) __post __deref __valid __refparam
...
#define __deref_out_z \
    __post __deref __valid __refparam __post __deref __nullterminated
...
#define __deref_inout              \
    __notnull __elem_readableTo(1) \
        __pre __deref __valid __post __deref __valid __refparam
#define __deref_inout_z \
    __deref_inout __pre __deref __nullterminated __post __deref __nullterminated
#define __deref_inout_ecount(size)                      \
    __deref_inout __pre __deref __elem_writableTo(size) \
    __post __deref __elem_writableTo(size)
#define __deref_inout_bcount(size)                      \
    __deref_inout __pre __deref __byte_writableTo(size) \
    __post __deref __byte_writableTo(size)
...
#define __deref_ecount_opt(size) \
    __deref_ecount(size) __post __deref __exceptthat __maybenull
#define __deref_bcount_opt(size) \
    __deref_bcount(size) __post __deref __exceptthat __maybenull
#define __deref_out_opt __deref_out __post __deref __exceptthat __maybenull
#define __deref_out_ecount_opt(size) \
    __deref_out_ecount(size) __post __deref __exceptthat __maybenull
#define __deref_out_bcount_opt(size) \
    __deref_out_bcount(size) __post __deref __exceptthat __maybenull
...
#define __deref_out_ecount_full_opt(size) \
    __deref_out_ecount_full(size) __post __deref __exceptthat __maybenull
#define __deref_out_bcount_full_opt(size) \
    __deref_out_bcount_full(size) __post __deref __exceptthat __maybenull
#define __deref_out_z_opt                                                      \
    __post __deref __valid __refparam __execeptthat __maybenull __post __deref \
        __nullterminated
...
#define __deref_inout_opt                                               \
    __deref_inout __pre __deref __exceptthat __maybenull __post __deref \
        __exceptthat __maybenull
#define __deref_inout_ecount_opt(size)                                       \
    __deref_inout_ecount(size) __pre __deref __exceptthat __maybenull __post \
        __deref __exceptthat __maybenull
#define __deref_inout_bcount_opt(size)                                       \
    __deref_inout_bcount(size) __pre __deref __exceptthat __maybenull __post \
        __deref __exceptthat __maybenull
#define __deref_inout_ecount_part_opt(size, length)                    \
    __deref_inout_ecount_part(size, length) __pre __deref __exceptthat \
        __maybenull __post __deref __exceptthat __maybenull
#define __deref_inout_bcount_part_opt(size, length)                    \
    __deref_inout_bcount_part(size, length) __pre __deref __exceptthat \
        __maybenull __post __deref __exceptthat __maybenull
#define __deref_inout_ecount_full_opt(size)                                \
    __deref_inout_ecount_full(size) __pre __deref __exceptthat __maybenull \
        __post __deref __exceptthat __maybenull
#define __deref_inout_bcount_full_opt(size)                                \
    __deref_inout_bcount_full(size) __pre __deref __exceptthat __maybenull \
        __post __deref __exceptthat __maybenull
#define __deref_inout_z_opt                                         \
    __deref_inout_opt __pre __deref __nullterminated __post __deref \
        __nullterminated
...
#define __deref_opt_out_ecount(size) \
    __deref_out_ecount(size) __exceptthat __maybenull
#define __deref_opt_out_bcount(size) \
    __deref_out_bcount(size) __exceptthat __maybenull
...
#define __deref_opt_out_ecount_full(size) \
    __deref_out_ecount_full(size) __exceptthat __maybenull
#define __deref_opt_out_bcount_full(size) \
    __deref_out_bcount_full(size) __exceptthat __maybenull
#define __deref_opt_inout __deref_inout __exceptthat __maybenull
#define __deref_opt_inout_ecount(size) \
    __deref_inout_ecount(size) __exceptthat __maybenull
#define __deref_opt_inout_bcount(size) \
    __deref_inout_bcount(size) __exceptthat __maybenull
...
#define __deref_opt_inout_ecount_full(size) \
    __deref_inout_ecount_full(size) __exceptthat __maybenull
#define __deref_opt_inout_bcount_full(size) \
    __deref_inout_bcount_full(size) __exceptthat __maybenull
#define __deref_opt_inout_z                                         \
    __deref_opt_inout __pre __deref __nullterminated __post __deref \
        __nullterminated
...
#define __deref_opt_ecount_opt(size) \
    __deref_ecount_opt(size) __exceptthat __maybenull
#define __deref_opt_bcount_opt(size) \
    __deref_bcount_opt(size) __exceptthat __maybenull
#define __deref_opt_out_opt __deref_out_opt __exceptthat __maybenull
#define __deref_opt_out_ecount_opt(size) \
    __deref_out_ecount_opt(size) __exceptthat __maybenull
#define __deref_opt_out_bcount_opt(size) \
    __deref_out_bcount_opt(size) __exceptthat __maybenull
...
#define __deref_opt_out_bcount_full_opt(size) \
    __deref_out_bcount_full_opt(size) __exceptthat __maybenull
#define __deref_opt_out_z_opt                                                   \
    __post __deref __valid __refparam __exceptthat __maybenull __pre __deref    \
        __exceptthat __maybenull __post __deref __exceptthat __maybenull __post \
...
#define __deref_opt_inout_ecount_opt(size) \
    __deref_inout_ecount_opt(size) __exceptthat __maybenull
#define __deref_opt_inout_bcount_opt(size) \
    __deref_inout_bcount_opt(size) __exceptthat __maybenull
...
#define __deref_opt_inout_ecount_full_opt(size) \
    __deref_inout_ecount_full_opt(size) __exceptthat __maybenull
#define __deref_opt_inout_bcount_full_opt(size) \
    __deref_inout_bcount_full_opt(size) __exceptthat __maybenull
#define __deref_opt_inout_z_opt                                         \
    __deref_opt_inout_opt __pre __deref __nullterminated __post __deref \
        __nullterminated
