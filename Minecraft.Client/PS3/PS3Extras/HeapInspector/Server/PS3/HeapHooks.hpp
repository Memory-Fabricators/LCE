...
extern "C" void *__wrap_calloc(size_t a_NumElements, size_t a_SizePerElement)
{
    ...
    size_t usableSize = malloc_usable_size(result);
    HeapInspectorServer::EndAlloc(mutation, 0, result,
                                  a_NumElements * a_SizePerElement, usableSize);
    return result;
}
...
extern "C" void *__wrap_realloc(void *a_Address, size_t a_Size)
{
    ...
    size_t usableSize = malloc_usable_size(result);
    HeapInspectorServer::EndReAlloc(mutation, 0, a_Address, result, a_Size,
                                    usableSize);
    return result;
}

extern "C" void *__real_reallocalign(void *a_Address, size_t a_Size,
                                     size_t a_Boundary);
extern "C" void *__wrap_reallocalign(void *a_Address, size_t a_Size,
                                     size_t a_Boundary)
{
    HeapInspectorServer::Mutation mutation = HeapInspectorServer::BeginReAlloc();
