...
// template <	class T, class H = hash<T>, class P = std::equal_to<T>, class A
// = boost::pool_allocator<T> > 	class unordered_set : public
// std::tr1::unordered_set<T, H, P, A >
// {};
//
// template <class K, class T, class H = hash<K>, class P = std::equal_to<K>,
// class A = boost::pool_allocator<std::pair<const K,T> > > 	class
// unordered_map : public std::tr1::unordered_map<K, T, H, P, A >
// {};

// template <	class T, class H = hash<T>, class P = std::equal_to<T>, class A
// = C4JPoolAllocator<T> > class unordered_set : public
// std::tr1::unordered_set<T, H, P, A >
// {};
//
// template <class K, class T, class H = hash<K>, class P = std::equal_to<K>,
// class A = C4JPoolAllocator<std::pair<const K,T> > > class unordered_map :
// public std::tr1::unordered_map<K, T, H, P, A >
// {};
