...
void C4JThread_SPU::initSPURS()
{
    ...
    ret = cell::Spurs::SpursAttribute::initialize(
        &attribute, SPURS_MAX_SPU - 1, SPURS_SPU_THREAD_PRIORITY,
        SPURS_PPU_THREAD_PRIORITY, false);
    if (ret)
    {
#ifndef _CONTENT_PACKAGE
    ...
    ret = attribute.setSpuThreadGroupType(
