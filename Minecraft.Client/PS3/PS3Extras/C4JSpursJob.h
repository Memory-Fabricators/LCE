...
// 			C4JSpursJobEventQueueFunc* func =
// (C4JSpursJobEventQueueFunc*)event.data1;
// func(event.data2, event.data3); 		} while(1); 		return
// 0;
// 	}
//
// 	void  CompressedTileStorage::compress_SPUSendEvent(int
// upgradeBlock/*=-1*/)
// 	{
// 		if(g_pCompressSPUThread == NULL)
// 		{
// 			sys_event_port_create(&g_basicEventPort,
// SYS_EVENT_PORT_LOCAL, SYS_EVENT_PORT_NO_NAME);
// sys_event_queue_attribute_t queue_attr = {SYS_SYNC_PRIORITY, SYS_PPU_QUEUE};
// 			sys_event_queue_create(&g_basicEventQueue, &queue_attr,
// SYS_EVENT_QUEUE_LOCAL, 127);
// sys_event_port_connect_local(g_basicEventPort, g_basicEventQueue);
//
// 			g_pCompressSPUThread = new
// C4JThread(compress_SPUEventPoll, this, "compress_SPU");
// 			g_pCompressSPUThread->Run();
// 		}
//
// 		sys_event_port_send(g_basicEventPort, (std::uint64_t)this,
// upgradeBlock, 0);
// 	}
//
// };
...
class C4JSpursJob_CompressedTile : public C4JSpursJob
{
  public:
    ...
    C4JSpursJob_CompressedTile(TileCompressData_SPU *pDataIn,
...
class C4JSpursJob_ChunkUpdate : public C4JSpursJob
{
  public:
    ...
    C4JSpursJob_ChunkUpdate(ChunkRebuildData *pDataIn,
...
// 	C4JSpursJob_Renderer_TextureUpdate(Renderer_TextureUpdate_DataIn*
// pDataIn);
// };
...
class C4JSpursJob_CompressedTileStorage_getData : public C4JSpursJob
{
  public:
    ...
    C4JSpursJob_CompressedTileStorage_getData(unsigned char *pIdxAndData,
                                              int dataSize, unsigned char *pDst,
...
// 	C4JSpursJob_GameRenderer_updateLightTexture(GameRenderer_updateLightTexture_dataIn*
// pDataIn);
// };
...
// 	C4JSpursJob_RLECompress(void* pSrc, int srcSize, void* pDst, int*
// pDstSize);
// };
...
class C4JSpursJobQueue
{
  ...
  public:
    static C4JSpursJobQueue &getMainJobQueue()
    {
        if (m_pMainJobQueue == NULL)
        {
            m_pMainJobQueue = new C4JSpursJobQueue;
        }
        return *m_pMainJobQueue;
    }
