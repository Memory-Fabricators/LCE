...
void ShutdownManager::Initialise()
{
    ...
    // considered as running - this will be unset by StorageManager.ExitRequest if
    // required
...
void ShutdownManager::MainThreadHandleShutdown()
{
    ...
    app.DebugPrintf("Shutdown manager: waiting on first batch of threads "
    ...
    // Finally shut down the spurs job queue - leaving until last so there should
    // be nothing else dependent on this still running
