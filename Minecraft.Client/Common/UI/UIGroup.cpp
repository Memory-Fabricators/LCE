...
void UIGroup::ReloadAll()
{
    ...
    for (; highestRenderable >= 0; --highestRenderable)
    {
        ...
        {
            m_layers[highestRenderable]->ReloadAll(highestRenderable != (int)eUILayer_Fullscreen);
        }
    }
}
...
void UIGroup::PrintTotalMemoryUsage(std::int64_t &totalStatic, std::int64_t &totalDynamic)
{
