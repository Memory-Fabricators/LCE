...
class GameRuleDefinition
{
  ...
  public:
    ...
    virtual GameRuleType getActionType() = 0;
    ...
    static wstring generateDescriptionString(GameRuleType defType, const wstring &description, void *data = NULL, int dataLength = 0);
};
