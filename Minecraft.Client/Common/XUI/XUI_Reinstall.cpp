                                    ...
                                    BOOL &rfHandled)
{
    ...
    case VK_PAD_X:
        // Change device
        // we need a function to deal with the return from this - if it changes, we
        // need to update the tooltips Fix for #12531 - TCR 001: BAS Game Stability:
        // When a player selects to change a storage device, and repeatedly backs
        // out of the SD screen, disconnects from LIVE, and then selects a SD, the
        // title crashes.
        m_bIgnoreInput = true;
        StorageManager.SetSaveDevice(&CScene_Reinstall::DeviceSelectReturned, this,
                                     true);
