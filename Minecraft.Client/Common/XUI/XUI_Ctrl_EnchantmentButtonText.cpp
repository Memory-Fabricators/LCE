...
{
    wstring allWords =
        L"the elder scrolls klaatu berata niktu xyzzy bless curse light darkness "
        L"fire air earth water hot dry cold wet ignite snuff embiggen twist "
        L"shorten stretch fiddle destroy imbue galvanize enchant free limited "
        L"range of towards inside sphere cube self other ball mental physical "
        L"grow shrink demon elemental spirit animal creature beast humanoid "
        L"undead fresh stale ";
