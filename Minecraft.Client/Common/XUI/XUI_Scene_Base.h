...
class CXuiSceneBase : public CXuiSceneImpl
{
  ...
  private:
    ...
    HRESULT _SetTooltipsEnabled(unsigned int iPad, bool bA = true, bool bB = true,
                                bool bX = true, bool bY = true, bool bLT = true,
                                bool bRT = true, bool bLB = true, bool bRB = true,
                                bool bLS = true);
  ...
  public:
    static CXuiSceneBase *GetInstance()
    {
        return Instance;
    }
