                                           ...
                                           BOOL &bHandled)
{
    ...
    CXuiSceneAbstractContainer::Initialize(
        initData->iPad, itemPickerMenu, false, -1, eSectionInventoryCreativeUsing,
        eSectionInventoryCreativeMax, initData->bNavigateBack);
...
//////////////////////////////////////////////////////////////////////////
HRESULT
CXuiSceneInventoryCreative::OnTransitionEnd(XUIMessageTransition *pTransData,
                                            BOOL &bHandled)
{
...
CXuiControl *
CXuiSceneInventoryCreative::GetSectionControl(ESceneSection eSection)
{
    switch (eSection)
    {
...
CXuiCtrlSlotList *
CXuiSceneInventoryCreative::GetSectionSlotList(ESceneSection eSection)
{
    switch (eSection)
    {
    case eSectionInventoryCreativeUsing:
