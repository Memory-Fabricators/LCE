...
CustomMessage_GetSlotItem(XUIMessage *pMsg,
                          CustomMessage_GetSlotItem_Struct *pData,
...
static __declspec(noinline) void
CustomMessage_Splitscreenplayer(XUIMessage *pMsg,
                                CustomMessage_Splitscreenplayer_Struct *pData,
                                bool bJoining)
{
...
static __declspec(noinline) void
CustomMessage_FontRendererChange(XUIMessage *pMsg)
{
...
static __declspec(noinline) void
CustomMessage_DLCMountingComplete(XUIMessage *pMsg)
{
...
static __declspec(noinline) void
CustomMessage_BasePositionChanged(XUIMessage *pMsg)
{
...
static __declspec(noinline) void
CustomMessage_TMS_DLCFileRetrieved(XUIMessage *pMsg)
{
...
static __declspec(noinline) void
CustomMessage_TMS_BanFileRetrieved(XUIMessage *pMsg)
{
