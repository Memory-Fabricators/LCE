...
HRESULT
CXuiCtrlSlotList::OnGetItemCountAll(XUIMessageGetItemCount *pGetItemCountData,
                                    BOOL &bHandled)
{
...
{
    // The direction is the direction in which we are leaving the previous control
    // to get to here So a Navigate up means we want to start at the bottom of
    // ourself
    switch (direction)
    {
