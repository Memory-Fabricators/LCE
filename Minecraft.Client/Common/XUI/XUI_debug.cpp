...
HRESULT CScene_Debug::OnInit(XUIMessageInit *pInitData, BOOL &bHandled)
{
    ...
    while ((*m_DebugButtonTextA[iButtonIndex]) != 0)
    {
        ...
        // if you're not the primary player, disable all these - you need a storage
        // device for them
...
HRESULT
CScene_Debug::OnControlNavigate(XUIMessageControlNavigate *pControlNavigateData,
                                BOOL &bHandled)
{
    if (m_bOnCheckboxes)
    {
        ...
        case XUI_CONTROL_NAVIGATE_UP:
            if (m_iCurrentCheckboxElement > 0)
            {
                ...
                XuiElementSetUserFocus(
                    m_DebugCheckboxDataA[m_iCurrentCheckboxElement].hXuiObj, m_iPad);
            }
            break;
        ...
        case XUI_CONTROL_NAVIGATE_RIGHT:
            ...
            XuiElementSetUserFocus(
                m_DebugButtonDataA[m_iCurrentButtonElement].hXuiObj, m_iPad);
            break;
        }
    }
    else
...
//----------------------------------------------------------------------------------
HRESULT
CScene_Debug::OnNotifyValueChanged(HXUIOBJ hObjSource,
...
//----------------------------------------------------------------------------------
HRESULT
CScene_Debug::OnNotifySelChanged(HXUIOBJ hObjSource,
                                      ...
                                      BOOL &rfHandled)
{
    ...
    // you need to be the primary player to be able to earn these, since you need
    // a storage device
