                                     ...
                                     BOOL &bHandled)
{
    ...
    // 4J-PB - changing all versions to use a list of buttons, since we're adding
    // some We're going to use a list of buttons here
...
HRESULT
CScene_HowToPlayMenu::OnCustomMessage_Splitscreenplayer(bool bJoining,
                                                        BOOL &bHandled)
{
    bHandled = true;
