...
int CXuiCtrlFireProgress::GetValue()
{
    ...
    if (pvUserData != NULL)
    {
        ...
        // TODO This param is a magic number in Java but we should really define it
        // somewhere with a name I think it is the number of states of the progress
        // display (ie the max value)
