                                     ...
                                     BOOL &rfHandled)
{
    ...
    case VK_ESCAPE:
        ...
        app.SetGameSettings(m_iPad, eGameSetting_DisplaySplitscreenGamertags,
        ...
        // if the splitscreen vertical/horizontal has changed, need to update the
        // scenes
            ...
            (m_SplitScreen.IsChecked() ? 1 : 0))
        {
            ...
            // close the xui scenes, so we don't have the navigate backed to menu at
            // the wrong place
                                             ...
                                             BOOL &bHandled)
{
        ...
        pTransition->dwTransType == XUI_TRANSITION_BACKTO)
    {
        ...
        // now the m_SplitScreenGamertags checkbox - let's just use the visual we
        // already have...
        ...
        // now the m_DeathMessages checkbox - let's just use the visual we already
        // have...
        hr = XuiTextPresenterMeasureText(hCheckboxText, m_DeathMessages.GetText(),
                                         &xuiRect);
