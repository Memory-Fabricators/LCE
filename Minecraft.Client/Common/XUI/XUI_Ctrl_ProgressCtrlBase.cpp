...
{
    // The Xui backend calls GetSourceDataText every frame to get the text for the
    // indexed label We don't want to change the label, but take this opportunity
    // to send out a message to ourself to update the value of the progress bar
