...
#endif
{
  ...
  public:
    ...
    bool LoadCommandBlockMenu(int iPad, shared_ptr<CommandBlockEntity> commandBlock)
    {
        return false;
    }
    ...
    void SetXuiServerAction(int iPad, eXuiServerAction action, LPVOID param = NULL)
    {
