...
class SonyRemoteStorage
{
  public:
    ...
    void getSaveInfo();
    bool waitingForSaveInfo()
    {
        return (m_getInfoStatus == e_gettingInfo);
    }
    ...
    bool waitingForSetData()
    {
        return (m_setDataStatus == e_settingData);
    }
    ...
    void SetServiceID(char *pchServiceID)
    {
        m_pchServiceID = pchServiceID;
    }
