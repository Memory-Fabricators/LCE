...
#ifndef __PSVITA__
#define SCE_TOOLKIT_NP_SKU_PRICE_LEN (SCE_NP_COMMERCE2_CURRENCY_CODE_LEN + SCE_NP_COMMERCE2_CURRENCY_SYMBOL_LEN + SCE_NP_COMMERCE2_THOUSAND_SEPARATOR_LEN + SCE_NP_COMMERCE2_DECIMAL_LETTER_LEN) ///< The maximum length of a price in characters.
#endif
