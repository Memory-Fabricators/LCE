...
#define XMEMCOMPRESS_STREAM 0x00000001
    ...
    HRESULT
    WINAPI
    XMemCreateCompressionContext(__in XMEMCODEC_TYPE CodecType,
    ...
    WINAPI
    XMemInitializeCompressionContext(__in XMEMCODEC_TYPE CodecType,
                                     __in_opt CONST VOID *pCodecParams,
                                     __in DWORD Flags,
    ...
    XBOXAPI
    VOID WINAPI XMemDestroyCompressionContext(__in XMEMCOMPRESSION_CONTEXT Context);

    XBOXAPI
    SIZE_T
    WINAPI
    XMemGetCompressionContextSize(__in XMEMCODEC_TYPE CodecType,
                                  __in_opt CONST VOID *pCodecParams,
                                  __in DWORD Flags);
    ...
    HRESULT
    WINAPI
    XMemResetCompressionContext(__in XMEMCOMPRESSION_CONTEXT Context);

    XBOXAPI
    HRESULT
    WINAPI
    XMemCompress(__in XMEMCOMPRESSION_CONTEXT Context,
                 __out_bcount_opt(*pDestSize) VOID *pDestination,
                 __inout SIZE_T *pDestSize,
                 __in_bcount(SrcSize) CONST VOID *pSource, __in SIZE_T SrcSize);

    XBOXAPI
    HRESULT
    WINAPI
    XMemCompressStream(__in XMEMCOMPRESSION_CONTEXT Context,
                       __out_bcount_opt(*pDestSize) VOID *pDestination,
                       __inout SIZE_T *pDestSize,
    ...
    HRESULT
    WINAPI
    XMemCreateDecompressionContext(__in XMEMCODEC_TYPE CodecType,
                                   __in_opt CONST VOID *pCodecParams,
                                   __in DWORD Flags,
    ...
    WINAPI
    XMemInitializeDecompressionContext(__in XMEMCODEC_TYPE CodecType,
                                       __in_opt CONST VOID *pCodecParams,
                                       __in DWORD Flags,
                                       __out_bcount(ContextSize) VOID *pContextData,
                                       __in SIZE_T ContextSize);
    ...
    XBOXAPI
    VOID WINAPI
    XMemDestroyDecompressionContext(__in XMEMDECOMPRESSION_CONTEXT Context);

    XBOXAPI
    SIZE_T
    WINAPI
    XMemGetDecompressionContextSize(__in XMEMCODEC_TYPE CodecType,
                                    __in_opt CONST VOID *pCodecParams,
                                    __in DWORD Flags);
    ...
    HRESULT
    WINAPI
    XMemResetDecompressionContext(__in XMEMDECOMPRESSION_CONTEXT Context);

    XBOXAPI
    HRESULT
    WINAPI
    XMemDecompress(__in XMEMDECOMPRESSION_CONTEXT Context,
    ...
    HRESULT
    WINAPI
    XMemDecompressStream(__in XMEMDECOMPRESSION_CONTEXT Context,
                         __out_bcount(*pDestSize) VOID *pDestination,
                         __inout SIZE_T *pDestSize,
                         __in_bcount(*pSrcSize) CONST VOID *pSource,
                         __inout SIZE_T *pSrcSize);
...
#define XCOMPRESS_SET_FILE_VERSION(Major, Minor) \
