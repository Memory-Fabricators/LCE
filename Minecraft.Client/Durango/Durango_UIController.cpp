...
void ConsoleUIController::init(
    ...
    Microsoft::WRL::ComPtr<ID3D11DepthStencilView> pDepthStencilView, S32 w,
    S32 h)
{
#ifdef _ENABLEIGGY
    ...
    gdraw_D3D11_SetResourceLimits(GDRAW_D3D11_RESOURCE_rendertarget, 10,
                                  32 * 1024 * 1024);
    gdraw_D3D11_SetResourceLimits(GDRAW_D3D11_RESOURCE_dynbuffer, 1,
                                  2 * 1024 * 1024);
...
void ConsoleUIController::render()
{
    ...
    gdraw_D3D11_SetTileOrigin(m_pRenderTargetView.Get(),
                              m_pDepthStencilView.Get(), NULL, 0, 0);
...
{
    gdraw_D3D11_SetTileOrigin(m_pRenderTargetView.Get(),
                              m_pDepthStencilView.Get(), NULL, xPos, yPos);
}
