...
class CPlatformNetworkManagerDurango : public CPlatformNetworkManager,
                                       IDQRNetworkManagerListener
{
  ...
  private:
    ...
    vector<DQRNetworkPlayer *>
        m_machineDQRPrimaryPlayers; // collection of players that we deem to be
