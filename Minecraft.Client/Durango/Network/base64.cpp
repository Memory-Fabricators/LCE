...
Platform::String ^
    base64_encode(unsigned char *chars_to_encode, unsigned int in_len)
{
    std::wstring ret;
    int i = 0;
    int j = 0;
...
void base64_decode(Platform::String ^ encoded_string, unsigned char *output,
                   unsigned int out_len)
{
    ...
    while (in_len-- && (encoded_string->Data()[in_] != L'=') &&
           is_base64(encoded_string->Data()[in_]))
    {
