...
class DurangoLeaderboardManager : public LeaderboardManager
{
  ...
  private:
    ...
    WF::IAsyncOperation<
        WFC::IVectorView<Microsoft::Xbox::Services::UserStatistics::
  ...
  public:
    ...
    virtual bool ReadStats_Friends(LeaderboardReadListener *listener,
                                   int difficulty, EStatsType type,
                                   PlayerUID myUID, unsigned int startIndex,
                                   unsigned int readCount);
    virtual bool ReadStats_MyScore(LeaderboardReadListener *listener,
                                   int difficulty, EStatsType type,
                                   PlayerUID myUID, unsigned int readCount);
    virtual bool ReadStats_TopRank(LeaderboardReadListener *listener,
                                   int difficulty, EStatsType type,
    ...
    static void GetProfilesCallback(
        LPVOID param,
  ...
  private:
    void runLeaderboardRequest(WF::IAsyncOperation<MXSL::LeaderboardResult ^> ^
                                   asyncOp,
                               int difficulty, EStatsType type,
                               unsigned int readCount, EFilterMode filter);
    void updateStatsInfo(int userIndex, int difficulty, EStatsType type,
                         WFC::IVectorView<MXS::UserStatistics::Statistic ^> ^
                             statsResult);
