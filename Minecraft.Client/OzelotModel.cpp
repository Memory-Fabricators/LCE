...
OzelotModel::OzelotModel()
{
    ...
    // 4J added - compile now to avoid random performance hit first time cubes are
    // rendered
...
void OzelotModel::render(shared_ptr<Entity> entity, float time, float r,
...
void OzelotModel::prepareMobModel(shared_ptr<Mob> mob, float time, float r,
                                  float a)
{
