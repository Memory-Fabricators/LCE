...
class C4JStorage
{
  ...
  public:
    ...
    C4JStorage::EMessageResult RequestMessageBox(
        ...
        LPVOID lpParam = NULL, C4JStringTable *pStringTable = NULL,
...
#ifdef _XBOX
    C4JStorage::ETMSStatus
    WriteTMSFile(int iPad, C4JStorage::eGlobalStorage eStorageFacility,
                 C4JStorage::eTMS_FileType eFileType, CHAR *pchFilePath,
                 CHAR *pchBuffer, DWORD dwBufferSize, TMSCLIENT_CALLBACK Func,
                 LPVOID lpParam);
    ...
    // TMSPP_GetUserQuotaInfo(int iPad,TMSCLIENT_CALLBACK Func,LPVOID lpParam, int
    // iUserData=0);
    C4JStorage::ETMSStatus
    ...
    // iUserData=0); 	bool
    // TMSPP_InFileList(eGlobalStorage eStorageFacility, int iPad,const wstring
