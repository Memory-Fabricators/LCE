...
void CConsoleMinecraftApp::TemporaryCreateGameStart()
{
    ...
    bool isFlat = false;
    std::int64_t seedValue = BiomeSource::findSeed(isFlat ? LevelType::lvl_flat : LevelType::lvl_normal); // 4J - was (new Random())->nextLong() - now trying to actually find a seed to suit our requirements
