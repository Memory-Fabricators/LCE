...
class CConsoleMinecraftApp : public CMinecraftApp
{
  ...
  public:
    ...
    SonyCommerce *GetCommerce()
    {
        return m_pCommerce;
    }
    SonyCommerce::CategoryInfo *GetCategoryInfo();
    std::vector<SonyCommerce::ProductInfo> *
    GetProductList(int iIndex); // default to fail if the additional details are
                                // not retrieved
    ...
    unordered_map<wstring, SONYDLC *> *GetSonyDLCMap()
    {
        return &m_SONYDLCMap;
    }
    ...
    SonyRemoteStorage *getRemoteStorage()
    {
        return m_pRemoteStorage;
    }

    void SetOptionsSaveDataDialogRunning(bool bVal)
    {
        m_bOptionsSaveDataDialogRunning = bVal;
    }
    bool GetOptionsSaveDataDialogRunning()
    {
        return m_bOptionsSaveDataDialogRunning;
    }
