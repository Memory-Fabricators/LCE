...
class SQRNetworkManager_Orbis : public SQRNetworkManager
{
  ...
  public:
    ...
    //	static bool
    // UpdateInviteData(SQRNetworkManager_Orbis::PresenceSyncInfo *invite);
  ...
  private:
    ...
    static void SignallingCallback(SceNpMatching2ContextId ctxId,
                                   ...
                                   void *arg);
    void ProcessSignallingEvent(SceNpMatching2ContextId ctxId,
                                SceNpMatching2RoomId roomId,
                                SceNpMatching2RoomMemberId peerMemberId,
                                SceNpMatching2Event event, int error_code);
...
#define SYSTEM_UI_WAIT_TIME 1000
  ...
  private:
    ...
    static const int MIN_PRESENCE_RESEND_TIME =
        30 * 1000; // Minimum presence send rate - doesn't seem possible to find
                   // out what this actually should be
