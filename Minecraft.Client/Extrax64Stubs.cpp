...
#include <libperf.h>
#elif defined _SDL3
#include "SDL3/Sentient/DynamicConfigurations.h"
#include "SDL3/Sentient/SentientManager.h"
#include "SDL3/Social/SocialManager.h"
#include "StatsCounter.h"
#else
...
#if defined(_WINDOWS64) || defined(_SDL3)
...
#if !defined(_XBOX_ONE) && !defined(_SDL3)
...
void C_4JProfile::SetUpsellCallback(int (*)(LPVOID, eUpsellResponse), LPVOID)
{
}
...
void C_4JProfile::SetDefaultOptionsCallback(void (*)(LPVOID, int), LPVOID)
{
}

void C_4JProfile::SetOldProfileVersionCallback(void (*)(LPVOID, int, int), LPVOID)
{
}

void C_4JProfile::SetSignInChangeCallback(void (*)(LPVOID, DWORD), LPVOID)
{
}

void C_4JProfile::SetNotificationsCallback(void (*)(LPVOID, DWORD), LPVOID)
{
}

void C_4JProfile::RegisterAward(int, DWORD, eAwardType, bool, CXuiStringTable *, int, int, int)
{
}
...
void C_4JProfile::RegisterRichPresenceContext(DWORD)
{
}

void C_4JProfile::SetRichPresenceContextValue(int, DWORD, DWORD)
{
}
...
void C_4JProfile::AwardAchievement(int, int)
{
}

void C_4JProfile::CheckAwards()
{
}

bool C_4JProfile::IsSignedIn(int)
{
    return true;
}

bool C_4JProfile::IsSignedInLive(int)
{
    return false;
}

bool C_4JProfile::IsGuest(int)
{
    return false;
}

bool C_4JProfile::AllowedToPlayMultiplayer(int)
{
    return false;
}

void C_4JProfile::GetXUID(int, PlayerUID *pXuid, bool)
{
    if (pXuid)
    {
        *pXuid = INVALID_XUID;
...
UINT C_4JProfile::RequestSignInUI(bool, bool, bool, bool, bool, int (*)(LPVOID, const bool, const int), LPVOID, int)
{
    return 0;
}

UINT C_4JProfile::RequestConvertOfflineToGuestUI(int (*)(LPVOID, const bool, const int), LPVOID, int)
{
    return 0;
}
...
eAwardType C_4JProfile::GetAwardType(int)
{
    return eAwardType_Achievement;
}

bool C_4JProfile::CanBeAwarded(int, int)
{
    return false;
}
