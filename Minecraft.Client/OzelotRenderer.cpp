...
void OzelotRenderer::render(shared_ptr<Entity> _mob, double x, double y,
...
{
    // 4J - original version used generics and thus had an input parameter of type
    // Blaze rather than shared_ptr<Entity>  we have here - do some casting around
    // instead
