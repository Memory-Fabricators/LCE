...
SmoothZoomLayer::SmoothZoomLayer(std::int64_t seedMixup, shared_ptr<Layer> parent) : Layer(seedMixup)
{
    this->parent = parent;
}
...
shared_ptr<Layer> SmoothZoomLayer::zoom(std::int64_t seed, shared_ptr<Layer> sup, int count)
{
