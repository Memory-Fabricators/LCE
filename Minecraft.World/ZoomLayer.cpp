...
ZoomLayer::ZoomLayer(std::int64_t seedMixup, shared_ptr<Layer> parent) : Layer(seedMixup)
{
    this->parent = parent;
}
...
shared_ptr<Layer> ZoomLayer::zoom(std::int64_t seed, shared_ptr<Layer> sup, int count)
{
