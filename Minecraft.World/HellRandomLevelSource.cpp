...
void HellRandomLevelSource::buildSurfaces(int xOffs, int zOffs, byteArray blocks)
{
    ...
    for (int x = 0; x < 16; x++)
    {
        for (int z = 0; z < 16; z++)
        {
            ...
            unsigned char top = Tile::hellRock_Id;
            unsigned char material = Tile::hellRock_Id;
                ...
                else
                {
                    ...
                    else if (old == Tile::hellRock_Id)
                    {
                        if (run == -1)
                        {
                            ...
                            {
                                top = 0;
                                material = Tile::hellRock_Id;
                            }
                            else if (y >= waterHeight - 4 && y <= waterHeight + 1)
                            {
                                top = Tile::hellRock_Id;
                                material = Tile::hellRock_Id;
                                if (gravel)
                                {
                                    top = Tile::gravel_Id;
                                ...
                                if (sand)
                                {
                                    ...
                                    {
                                        top = Tile::hellSand_Id;
                                    }
                                }
                                if (sand)
                                {
                                    material = Tile::hellSand_Id;
                                }
                            }

                            if (y < waterHeight && top == 0)
                            {
                                top = Tile::calmLava_Id;
                            }
