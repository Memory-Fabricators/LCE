...
int StemTile::getColor(int data)
{
    ...
    unsigned char redComponent = ((minColour >> 16) & 0xFF) + (((maxColour >> 16) & 0xFF - (minColour >> 16) & 0xFF) * (data / 7.0f));
    unsigned char greenComponent = ((minColour >> 8) & 0xFF) + (((maxColour >> 8) & 0xFF - (minColour >> 8) & 0xFF) * (data / 7.0f));
    unsigned char blueComponent = ((minColour) & 0xFF) + (((maxColour) & 0xFF - (minColour) & 0xFF) * (data / 7.0f));
