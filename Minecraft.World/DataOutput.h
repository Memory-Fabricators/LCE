...
class DataOutput
{
  public:
    ...
    virtual void write(std::span<std::byte> b) = 0;
    virtual void write(std::span<std::byte> b, unsigned int offset, unsigned int length) = 0;
    virtual void writeByte(std::byte a) = 0;
