...
class SignTileEntity : public TileEntity
{
  ...
  public:
    ...
    wstring GetMessage(int i)
    {
        return m_wsmessages[i];
    }
    wstring *GetMessages()
    {
        return m_wsmessages;
    ...
    int GetSelectedLine()
    {
        return m_iSelectedLine;
    }
    void SetSelectedLine(int iLine)
    {
    ...
    void SetCensored(bool bCensored)
    {
        m_bCensored = bCensored;
    }
