...
class Item : public std::enable_shared_from_this<Item>
{
  ...
  public:
    ...
    std::wstring getDescription(std::shared_ptr<ItemInstance> instance);
  ...
  public:
    ...
    virtual void appendHoverText(std::shared_ptr<ItemInstance> itemInstance, std::shared_ptr<Player> player, std::vector<HtmlString> *lines, bool advanced);
