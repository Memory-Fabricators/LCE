  ...
  public:
    class Library : public StrongholdPiece
    {
      public:
        ...
        virtual EStructurePiece GetType()
        {
            return eStructurePiece_Library;
        }
