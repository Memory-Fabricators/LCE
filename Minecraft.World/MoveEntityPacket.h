...
class MoveEntityPacket : public Packet, public enable_shared_from_this<MoveEntityPacket>
{
  ...
  public:
    ...
    {
        return shared_ptr<Packet>(new MoveEntityPacket());
    }
    virtual int getId()
    {
        return 30;
...
class MoveEntityPacket::PosRot : public MoveEntityPacket
{
  ...
  public:
    static shared_ptr<Packet> create()
    {
        return shared_ptr<Packet>(new MoveEntityPacket::PosRot());
    }
    virtual int getId()
    {
        return 33;
...
class MoveEntityPacket::Pos : public MoveEntityPacket
{
  ...
  public:
    static shared_ptr<Packet> create()
    {
        return shared_ptr<Packet>(new MoveEntityPacket::Pos());
    }
    virtual int getId()
    {
        return 31;
...
class MoveEntityPacket::Rot : public MoveEntityPacket
{
  ...
  public:
    static shared_ptr<Packet> create()
    {
        return shared_ptr<Packet>(new MoveEntityPacket::Rot());
    }
    virtual int getId()
    {
        return 32;
