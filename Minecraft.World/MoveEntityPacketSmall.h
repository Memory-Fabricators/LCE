...
class MoveEntityPacketSmall : public Packet, public enable_shared_from_this<MoveEntityPacketSmall>
{
  ...
  public:
    ...
    {
        return shared_ptr<Packet>(new MoveEntityPacketSmall());
    }
    virtual int getId()
    {
        return 162;
...
class MoveEntityPacketSmall::PosRot : public MoveEntityPacketSmall
{
  ...
  public:
    static shared_ptr<Packet> create()
    {
        return shared_ptr<Packet>(new MoveEntityPacketSmall::PosRot());
    }
    virtual int getId()
    {
        return 165;
...
class MoveEntityPacketSmall::Pos : public MoveEntityPacketSmall
{
  ...
  public:
    static shared_ptr<Packet> create()
    {
        return shared_ptr<Packet>(new MoveEntityPacketSmall::Pos());
    }
    virtual int getId()
    {
        return 163;
...
class MoveEntityPacketSmall::Rot : public MoveEntityPacketSmall
{
  ...
  public:
    static shared_ptr<Packet> create()
    {
        return shared_ptr<Packet>(new MoveEntityPacketSmall::Rot());
    }
    virtual int getId()
    {
        return 164;
