...
_Tier::Tier(int level, int uses, float speed, int damage, int enchantmentValue) : level(level),
                                                                                  uses(uses),
                                                                                  speed(speed),
                                                                                  damage(damage),
