...
#pragma warning(disable : 4826)
    dataAndCount.store(0x007F000000000000L | (((std::int64_t)planeIndices) & 0x0000ffffffffffffL), std::memory_order_release);
...
#pragma warning(disable : 4826)
    dataAndCount.store(0x0000000000000000L | (((std::int64_t)planeIndices) & 0x0000ffffffffffffL), std::memory_order_release);
#pragma warning(default : 4826)
#ifdef LIGHT_COMPRESSION_STATS
    count = 0;
#endif
...
{
    unsigned char *indicesAndData = (unsigned char *)(dataAndCount.load(std::memory_order_acquire) & 0x0000ffffffffffff);
...
SparseLightStorage::SparseLightStorage(SparseLightStorage *copyFrom)
{
    ...
    std::int64_t sourceDataAndCount = copyFrom->dataAndCount.load(std::memory_order_acquire);
...
#pragma warning(disable : 4826)
    dataAndCount.store((sourceDataAndCount & 0xffff000000000000L) | (((std::int64_t)destIndicesAndData) & 0x0000ffffffffffffL), std::memory_order_release);
#pragma warning(default : 4826)
...
#pragma warning(disable : 4826)
    std::int64_t newDataAndCount = ((std::int64_t)planeIndices) & 0x0000ffffffffffffL;
#pragma warning(default : 4826)
...
void SparseLightStorage::addNewPlane(int y)
{
    ...
    do
    {
        ...
        std::int64_t lastDataAndCount = dataAndCount.load(std::memory_order_acquire);
        ...
        // Get new data and count packed info
#pragma warning(disable : 4826)
        std::int64_t newDataAndCount = ((std::int64_t)dataPointer) & 0x0000ffffffffffffL;
#pragma warning(default : 4826)
        ...
        std::int64_t expected = lastDataAndCount;
        dataAndCount.compare_exchange_strong(expected, newDataAndCount, std::memory_order_release, std::memory_order_acquire);
        std::int64_t lastDataAndCount2 = expected;
...
int SparseLightStorage::compress()
{
    ...
    if (needsCompressed)
    {
        ...
        // Get new data and count packed info
#pragma warning(disable : 4826)
        std::int64_t newDataAndCount = ((std::int64_t)newIndicesAndData) & 0x0000ffffffffffffL;
#pragma warning(default : 4826)
