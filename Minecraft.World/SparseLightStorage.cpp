...
#pragma warning(disable : 4826)
    dataAndCount.store(0x007F000000000000L | (((__int64)planeIndices) & 0x0000ffffffffffffL), std::memory_order_release);
...
#pragma warning(disable : 4826)
    dataAndCount.store(0x0000000000000000L | (((__int64)planeIndices) & 0x0000ffffffffffffL), std::memory_order_release);
#pragma warning(default : 4826)
#ifdef LIGHT_COMPRESSION_STATS
    count = 0;
#endif
...
SparseLightStorage::SparseLightStorage(SparseLightStorage *copyFrom)
{
    ...
    __int64 sourceDataAndCount = copyFrom->dataAndCount.load(std::memory_order_acquire);
...
#pragma warning(disable : 4826)
    dataAndCount.store((sourceDataAndCount & 0xffff000000000000L) | (((__int64)destIndicesAndData) & 0x0000ffffffffffffL), std::memory_order_release);
#pragma warning(default : 4826)
...
void SparseLightStorage::addNewPlane(int y)
{
    ...
    do
    {
        ...
        __int64 lastDataAndCount = dataAndCount.load(std::memory_order_acquire);
