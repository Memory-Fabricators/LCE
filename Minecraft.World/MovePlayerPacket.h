...
class MovePlayerPacket : public Packet, public enable_shared_from_this<MovePlayerPacket>
{
  ...
  public:
    ...
    {
        return shared_ptr<Packet>(new MovePlayerPacket());
    }
    virtual int getId()
    {
        return 10;
...
class MovePlayerPacket::PosRot : public MovePlayerPacket
{
  ...
  public:
    static shared_ptr<Packet> create()
    {
        return shared_ptr<Packet>(new MovePlayerPacket::PosRot());
    }
    virtual int getId()
    {
        return 13;
...
class MovePlayerPacket::Pos : public MovePlayerPacket
{
  ...
  public:
    static shared_ptr<Packet> create()
    {
        return shared_ptr<Packet>(new MovePlayerPacket::Pos());
    }
    virtual int getId()
    {
        return 11;
...
class MovePlayerPacket::Rot : public MovePlayerPacket
{
  ...
  public:
    static shared_ptr<Packet> create()
    {
        return shared_ptr<Packet>(new MovePlayerPacket::Rot());
    }
    virtual int getId()
    {
        return 12;
