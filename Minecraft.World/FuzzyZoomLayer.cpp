...
FuzzyZoomLayer::FuzzyZoomLayer(std::int64_t seedMixup, shared_ptr<Layer> parent) : Layer(seedMixup)
{
    this->parent = parent;
}
...
shared_ptr<Layer> FuzzyZoomLayer::zoom(std::int64_t seed, shared_ptr<Layer> sup, int count)
{
