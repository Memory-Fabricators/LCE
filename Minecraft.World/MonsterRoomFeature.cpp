...
shared_ptr<ItemInstance> MonsterRoomFeature::randomItem(Random *random)
{
    ...
    if (type == 0)
    {
        return shared_ptr<ItemInstance>(new ItemInstance(Item::saddle));
    }
    if (type == 1)
    {
        return shared_ptr<ItemInstance>(new ItemInstance(Item::ironIngot, random->nextInt(4) + 1));
    }
    if (type == 2)
    {
        return shared_ptr<ItemInstance>(new ItemInstance(Item::bread));
    }
    if (type == 3)
    {
        return shared_ptr<ItemInstance>(new ItemInstance(Item::wheat, random->nextInt(4) + 1));
    }
    if (type == 4)
    {
        return shared_ptr<ItemInstance>(new ItemInstance(Item::sulphur, random->nextInt(4) + 1));
    }
    if (type == 5)
    {
        return shared_ptr<ItemInstance>(new ItemInstance(Item::string, random->nextInt(4) + 1));
    }
    if (type == 6)
    {
    ...
    {
        return shared_ptr<ItemInstance>(new ItemInstance(Item::apple_gold));
    }
    if (type == 8 && random->nextInt(2) == 0)
    {
        return shared_ptr<ItemInstance>(new ItemInstance(Item::redStone, random->nextInt(4) + 1));
    }
    if (type == 9 && random->nextInt(10) == 0)
    {
        return shared_ptr<ItemInstance>(new ItemInstance(Item::items[Item::record_01->id + random->nextInt(2)]));
    }
    if (type == 10)
    {
        return shared_ptr<ItemInstance>(new ItemInstance(Item::dye_powder, 1, DyePowderItem::BROWN));
    }
    if (type == 11)
    {
        return Item::enchantedBook->createForRandomLoot(random);
    }
